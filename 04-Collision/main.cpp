...
void LoadResources()
{
	...
	sprites->Add(10004, 395, 275, 421, 301, texMario); // big jump left

	sprites->Add(10005, 395, 80, 421, 96, texMario);

	sprites->Add(10011, 186, 154, 200, 181, texMario);		// idle left
	sprites->Add(10012, 155, 154, 170, 181, texMario);		// walk
	sprites->Add(10013, 125, 154, 140, 181, texMario);

	sprites->Add(10014, 35, 275, 51, 301, texMario); // big jump right

	sprites->Add(10015, 35, 80, 51, 96, texMario);
	...
	mario->AddAnimation(404); //Big Jump
	mario->AddAnimation(405);
